        ...
        <div className="p-5 sm:p-6 border-b border-white/5 flex items-start justify-between gap-4 bg-gradient-to-r from-[#171126] to-[#140f20]">
          <div className="space-y-1">
            ...
            <h3 className="text-xl sm:text-2xl font-serif font-bold text-white leading-tight">
              Scan Google Notes & Keep
            </h3>
            <p className="text-xs text-purple-200/70">
              Paste one or multiple notes. AI automatically cleans weird bullets and extracts your recipes.
            </p>
          </div>
          ...
          {!extractedRecipes ? (
            <form onSubmit={handleScanNotes} className="space-y-4">
              <div>
                ...
                <textarea
                  rows={8}
                  placeholder={`Example from Google Keep:&#10;&#10;Dad's Pancakes:&#10;• 2 cups flour&#10;• 2 tsp baking powder&#10;• 2 eggs&#10;• 1.5 cups milk&#10;&#10;Mix dry then wet, cook on hot skillet until bubbling.`}
                  value={noteText}
              ...
              <div className="pt-2 flex justify-end gap-2">
                ...
                >
                  ...
                  <span>{scanning ? 'Cleaning & Scanning...' : 'Scan Notes'}</span>
                </button>
              </div>
            </form>
          ) : (
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold text-purple-300 font-mono">
                  Extracted {extractedRecipes.length} Recipe{extractedRecipes.length === 1 ? '' : 's'}:
                </span>
                <span className="text-xs text-purple-400">
                  {selectedIndices.size} selected for vault
                </span>
              </div>
